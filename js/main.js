...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (exhibitorTrack) {
        ...
        const logos = [
            { name: "Bühnenbau Wertheim", url: baseUrl + "assets/logos/220110_BTT_Website_Logo_BuehnenbauWertheim.png" },
            { name: "ASM", url: baseUrl + "assets/logos/ASM-Logo_342x200_black.png" },
            { name: "Conductix Wampfler", url: baseUrl + "assets/logos/Conductix_Wampfler_logo.png" },
            { name: "DPA", url: baseUrl + "assets/logos/DPA_images_logo.png" },
            { name: "ETC", url: baseUrl + "assets/logos/ETC_4c_pos_2inches.png" },
            { name: "Feiner Lichttechnik", url: baseUrl + "assets/logos/Feiner_LOGO_300.png" },
            { name: "GLP", url: baseUrl + "assets/logos/GLP-logo-black.png" },
            { name: "Gala Systems", url: baseUrl + "assets/logos/Galasystems_logo.png" },
            { name: "Gerriets", url: baseUrl + "assets/logos/Gerriets-Logo-RGB-space.png" },
            { name: "Green Motion", url: baseUrl + "assets/logos/Green-Motion-Logo.png" },
            { name: "HOAC", url: baseUrl + "assets/logos/HOAC.png" },
            { name: "Harlequin Floors", url: baseUrl + "assets/logos/Harlequin Floors.png" },
            { name: "JB-Lighting", url: baseUrl + "assets/logos/JB-Lighting_Logo.png" },
            { name: "Waagner-Biro", url: baseUrl + "assets/logos/Logo_WaagnerBiro_RGB.webp" },
            { name: "Müller-BBM", url: baseUrl + "assets/logos/MuellerBBM_60mm_300dpi.png" },
            { name: "Chauvet Professional", url: baseUrl + "assets/logos/PNG_BL_CHAUVET_Professional.png" },
            { name: "Pan Acoustics", url: baseUrl + "assets/logos/PanAcoustics_logo.png" },
            { name: "Riedel", url: baseUrl + "assets/logos/Riedel_Logo_4c.svg.png" },
            { name: "Robe", url: baseUrl + "assets/logos/Robe Logo 1.png" },
            { name: "Scala", url: baseUrl + "assets/logos/SCALA_Logo_Deep_Blue_Zusatz_RGB.png" },
            { name: "Sennheiser", url: baseUrl + "assets/logos/Sennheiser_Logoline_RGB_4x.png" },
            { name: "Trad As", url: baseUrl + "assets/logos/Trad_As_logo.png" },
            { name: "WW Sales", url: baseUrl + "assets/logos/WW_Sales_images.png" },
            { name: "BWKI", url: baseUrl + "assets/logos/bwki_logo_standard-neu.png" },
            { name: "cast", url: baseUrl + "assets/logos/cast_Logo-mit-Motto.png" },
            { name: "industrial arts", url: baseUrl + "assets/logos/industrialarts_logo.png" },
            { name: "Kaiser", url: baseUrl + "assets/logos/kaiser_logo1.png" },
            { name: "Trekwerk", url: baseUrl + "assets/logos/logo-Trekwerk.png" },
            { name: "megaCAD", url: baseUrl + "assets/logos/megaCAD_Logo.png" },
            { name: "Nüssli", url: baseUrl + "assets/logos/nuessli_logo.png" },
            { name: "Primary Logo", url: baseUrl + "assets/logos/primary-logo-big-rgb-pos.png" },
            { name: "Publitec", url: baseUrl + "assets/logos/publitec Logo schwarz_transparent.png" },
            { name: "Schnakenberg", url: baseUrl + "assets/logos/schnakenberg-logo-0212.png" },
            { name: "Shure", url: baseUrl + "assets/logos/shure_tile_rgb.png" },
            { name: "Unican", url: baseUrl + "assets/logos/unican_white.png" }
        ];
