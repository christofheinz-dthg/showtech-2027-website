      ...
      <form id="sib-form" method="POST" action="https://421e8861.sibforms.com/serve/MUIFAI7Ta4MS6vOVEa615Sb_hI1kD63WUC0pa_cAE3muYuuMu-XvCQNhZx2PWwhl2a5Z34OlXvsrQZlpGqPxgQK9jP8xbrf9qhkYoZ33Z363y8HeEqdnBjCSdELhJyJqJSTf0qeX7oTwf2GYkaShPTUIY1E6bNx7nkh2VjdYunDKKRAIiPCoejdjlxfUrBZZDbFVdqgEiHWB3sv8" data-type="subscription">
          ...
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              <div class="form__label-row ">
                ...
                <label class="entry__label" style="font-weight: 700; text-align: left; font-family:Helvetica, sans-serif; font-size:16px; font-weight:700; text-align:left; color:#3c4858;" for="VORNAME" data-required="*">Vorname</label>
          ...
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              <div class="form__label-row ">
                ...
                <label class="entry__label" style="font-weight: 700; text-align: left; font-family:Helvetica, sans-serif; font-size:16px; font-weight:700; text-align:left; color:#3c4858;" for="EMAIL" data-required="*">E-Mail:</label>
        ...
        <div style="padding: 8px 0;">
          ...
          <div class="sib-optin sib-form-block">
            ...
            style="margin-left:"
            ></span><span style="font-family:Helvetica, sans-serif; font-size:14px; text-align:left; color:#3C4858; background-color:transparent;"><p>Ja, ich möchte den SHOWTECH-Newsletter mit weiteren Informationen zur Veranstaltung erhalten</p></span>
        ...
        <div style="padding: 8px 0;">
          ...
          <div class="sib-form__declaration" style="direction:ltr">
            ...
            <div style="font-family:Helvetica, sans-serif; font-size:14px; text-align:left; color:#687484; background-color:transparent;">
              <p>Wir nutzen Brevo als unsere Marketing-Plattform. Mit dem Absenden des Formulars erklären Sie sich damit einverstanden, dass die von Ihnen bereitgestellten personenbezogenen Daten zur Verarbeitung an Brevo übermittelt werden – in Übereinstimmung mit</p>
              <p><a href="https://www.brevo.com/de/legal/privacypolicy/" rel="nofollow"><u>Brevo&#39;s Datenschutzbestimmungen</u></a></p>
            </div>
          </div>
